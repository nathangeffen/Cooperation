...
# Generated by qmake (2.01a) (Qt 4.7.4) on: Tue Jan 24 13:46:53 2012
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/cooperation1.0.0 || $(MKDIR) .tmp/cooperation1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/cooperation1.0.0/ && $(COPY_FILE) --parents game.h competitor.h .tmp/cooperation1.0.0/ && $(COPY_FILE) --parents main.cpp game.cpp competitor.cpp .tmp/cooperation1.0.0/ && (cd `dirname .tmp/cooperation1.0.0` && $(TAR) cooperation1.0.0.tar cooperation1.0.0 && $(COMPRESS) cooperation1.0.0.tar) && $(MOVE) `dirname .tmp/cooperation1.0.0`/cooperation1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/cooperation1.0.0
...
competitor.o: competitor.cpp competitor.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o competitor.o competitor.cpp
